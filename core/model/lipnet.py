...
class LipNet(object):
    def __init__(
        ...
        input_shape = self.get_input_shape(
            frame_count, image_channels, image_height, image_width
        )
    ...
    @staticmethod
    def get_input_shape(
        frame_count: int, image_channels: int, image_height: int, image_width: int
    ) -> tuple:
